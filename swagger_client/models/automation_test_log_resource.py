...
class AutomationTestLogResource(object):
    ...
    """
    def __init__(self, links=None, id=None, test_case_version_id=None, exe_start_date=None, exe_end_date=None, note=None, attachments=None, name=None, planned_exe_time=None, actual_exe_time=None, build_number=None, build_url=None, properties=None, system_name=None, status=None, order=None, test_step_logs=None, module_names=None, agent_ids=None, automation_content=None):
        """
    ...
    def agent_ids(self):
        """
        Gets the agent_ids of this AutomationTestLogResource.

        :return: The agent_ids of this AutomationTestLogResource.
        :rtype: list[int]
        """
    ...
    def agent_ids(self, agent_ids):
        ...
        :param agent_ids: The agent_ids of this AutomationTestLogResource.
        :type: list[int]
        """
